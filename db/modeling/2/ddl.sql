...
ALTER TABLE join_workspaces
    ADD CONSTRAINT fk_join_workspaces_workspace_uuid
        FOREIGN KEY (workspace_uuid)
            REFERENCES workspaces (workspace_uuid);
...
ALTER TABLE thread_messages
    ADD CONSTRAINT fk_thread_messages_message_uuid
        FOREIGN KEY (message_uuid)
            REFERENCES messages (message_uuid);
...
CREATE INDEX idx_join_workspaces_workspace_uuid ON join_workspaces (workspace_uuid);

CREATE INDEX idx_join_channels_user_uuid ON join_channels (user_uuid);
CREATE INDEX idx_join_channels_channel_id ON join_channels (channel_uuid);
